defmodule Elixir4vet.AccountsTest do
  ...
  describe "update_user_password/2" do
    ...
    test "validates current password", %{user: user} do
      ...
      assert Accounts.get_user_by_email_and_password(user.email, "another valid password")
    end
  end
