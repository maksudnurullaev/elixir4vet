defmodule Elixir4photos.Accounts do
  @moduledoc """
  ...
  alias Elixir4photos.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Elixir4photos.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Elixir4photos.Accounts.User.password_changeset/3` for a list of supported options.
