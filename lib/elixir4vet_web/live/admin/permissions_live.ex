defmodule Elixir4vetWeb.Admin.PermissionsLive do
  use Elixir4vetWeb, :live_view

  alias Elixir4vet.Authorization
  alias Elixir4vet.Authorization.RolePermission
  ...
  def handle_event(
        "change_permission",
        %{"role-id" => role_id, "resource" => resource, "permission" => permission},
        socket
      ) do
                    ...
                    <%= for perm <- row.permissions do %>
                      <td class="text-center">
                        <select
                          ...
                          name="permission"
                        >
                          <option value="NA" selected={perm.permission == "NA"} class="text-error">
                            ❌ NA
                          </option>
                          <option value="RO" selected={perm.permission == "RO"} class="text-warning">
                            👁️ RO
                          </option>
                          <option value="RW" selected={perm.permission == "RW"} class="text-success">
                            ✏️ RW
                          </option>
                        </select>
                      </td>
