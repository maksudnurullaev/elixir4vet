defmodule Elixir4photosWeb.Plugs.SetLocale do
  import Plug.Conn

  @supported_locales Gettext.known_locales(Elixir4photosWeb.Gettext)
  ...
  def call(conn, _default) do
    locale = get_locale_from_params(conn) ||
             ...
             Gettext.get_locale(Elixir4photosWeb.Gettext)
